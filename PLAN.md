...
## 4. Relationship to the existing repository

This repo currently holds a static marketing page (`index.html`) for "Wichita EPE
Membership." The sponsor-management app is a **separate Next.js application**. Two
options — I recommend **Option A**:

- **Option A (recommended):** Build the app in this repo under a clear structure and
  keep the existing `index.html` untouched. Cleanest history, one place to look.
- **Option B:** Create a brand-new repository just for the app.

I'll assume Option A unless you tell me otherwise. Nothing about `index.html` will be
deleted or changed during the build.

## 5. Proposed project structure

```
wichita-epe-membership/
├── index.html                     # existing static site (left untouched)
├── PLAN.md  DATABASE.md  TASKS.md  # planning docs (this stage)
│
